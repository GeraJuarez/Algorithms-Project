...
//Inserting BioShock 2
string BioShock_2_tags[20] = {"FPS","Action","Singleplayer","Story Rich","Atmospheric","Shooter","First-Person","Horror","Steampunk","Sci-fi","Multiplayer","Underwater","RPG","Adventure","Dystopian ","Dark","Great Soundtrack","Action RPG","Philisophical","Linear"};
g.insert_game("BioShock 2", "2K Marin, 2K China, Digital Extremes, 2K Australia, Feral Interactive (Mac)", "2K Games, Feral Interactive (Mac)", BioShock_2_tags, 20);
...
string Borderlands_tags[20] = {"FPS","RPG","Co-op","Action","Loot","Online Co-Op","Shooter","First-Person","Open World","Comedy","Sci-fi","Multiplayer","Post-apocalyptic","Singleplayer","Action RPG","Funny","Adventure","Dark Humor","Gore","Local Co-Op"};
...
string Fallout_Shelter_tags[20] = {"Free to Play","Survival","Post-apocalyptic","Simulation","Singleplayer","Base-Building","Strategy","Management","2D","RPG","Casual","Adventure","Building","Crafting","Action","Sandbox","Multiplayer","Funny","Atmospheric","Great Soundtrack"};
...
//Inserting Dead Space
string Dead_Space_tags[20] = {"Horror","Action","Sci-fi","Space","Third Person","Survival Horror","Third-Person Shooter","Atmospheric","Singleplayer","Gore","Shooter","Aliens","Dark","Futuristic","Silent Protagonist","Story Rich","Survival","Adventure","Zombies","RPG"};
g.insert_game("Dead Space", "EA Redwood Shores", "Electronic Arts", Dead_Space_tags, 20);
//Inserting TrackMania Nations Forever
string TrackMania_Nations_Forever_tags[20] = {"Racing","Free to Play","Multiplayer","Singleplayer","Arcade","Level Editor","Simulation","Massively Multiplayer","Action","Competitive","Difficult","Adventure","Sandbox","Controller","Sports","Co-op","First-Person","Casual","Strategy","Open World"};
g.insert_game("TrackMania Nations Forever", "Nadeo", "Ubisoft", TrackMania_Nations_Forever_tags, 20);
...
//Inserting Star Trek Online
string Star_Trek_Online_tags[20] = {"Free to Play","Sci-fi","Massively Multiplayer","Space","RPG","MMORPG","Action","Open World","Multiplayer","Character Customization","Third Person","Adventure","Co-op","PvP","PvE","Online Co-Op","Strategy","Singleplayer","Tactical","Action RPG"};
g.insert_game("Star Trek Online", "Cryptic Studios", "Perfect World Entertainment", Star_Trek_Online_tags, 20);
//Inserting Banished
...
string World_of_Tanks_Blitz_tags[20] = {"Tanks","Free to Play","Action","Multiplayer","World War II","Massively Multiplayer","War","Strategy","Shooter","PvP","Simulation","Competitive","Online Co-Op","Military","Arcade","Open World","First-Person","Psychological Horror","FPS","Singleplayer"};
...
//Inserting Natural Selection 2
string Natural_Selection_2_tags[20] = {"Strategy","Multiplayer","FPS","Team-Based","Action","Sci-fi","RTS","Indie","Aliens","Competitive","Moddable","Shooter","Co-op","Tactical","First-Person","Space","Atmospheric","Online Co-Op","Futuristic","Adventure"};
g.insert_game("Natural Selection 2", "Unknown Worlds Entertainment", "Unknown Worlds Entertainment", Natural_Selection_2_tags, 20);
//Inserting Codename CURE
string Codename_CURE_tags[20] = {"Early Access","Free to Play","Zombies","Multiplayer","Shooter","Survival","FPS","Co-op","Action","Online Co-Op","First-Person","Horror","Gore","Singleplayer","Open World","Mod","Massively Multiplayer","Adventure","Funny","Third Person"};
...
string Last_Man_Standing_tags[20] = {"Free to Play","Survival","Multiplayer","Action","Open World","Shooter","Massively Multiplayer","First-Person","PvP","Adventure","Third-Person Shooter","FPS","Strategy","Violent","Co-op","Indie","Third Person","Singleplayer","Funny","Zombies"};
...
string Jet_Set_Radio_tags[20] = {"Great Soundtrack","Classic","Action","Platformer","3D Platformer","Singleplayer","Colorful","Arcade","Stylized","Music","Atmospheric","Third Person","Controller","Sports","Parkour","Anime","Retro","Open World","Cult Classic","Female Protagonist"};
...
//Inserting Psychonauts
string Psychonauts_tags[20] = {"Platformer","Comedy","Adventure","Cult Classic","Action","Singleplayer","Third Person","Funny","3D Platformer","Psychological","Classic","Story Rich","Exploration","Cartoony","Great Soundtrack","Surreal","Action-Adventure","Indie","Cute","3D Vision"};
g.insert_game("Psychonauts", "Double Fine Productions", "Double Fine Productions", Psychonauts_tags, 20);
...
//Inserting ArcheAge
string ArcheAge_tags[20] = {"Massively Multiplayer","Free to Play","MMORPG","RPG","Open World","Sandbox","Fantasy","Adventure","PvP","Multiplayer","PvE","Action","Pirates","Exploration","Crafting","Walking Simulator","Nudity","Third Person","Co-op","Gambling"};
...
//Inserting Just Cause
string Just_Cause_tags[10] = {"Action","Open World","Shooter","Third Person","Singleplayer","Adventure","Sandbox","Third-Person Shooter","Classic","Multiplayer"};
g.insert_game("Just Cause", "Avalanche Studios", "Square Enix", Just_Cause_tags, 10);
//Inserting WAKFU
...
//Inserting EVE Online
string EVE_Online_tags[20] = {"Space","Massively Multiplayer","Sci-fi","Sandbox","MMORPG","Open World","RPG","PvP","Multiplayer","Economy","Strategy","Space Sim","Simulation","Difficult","Tactical","Action","Capitalism","Free to Play","Atmospheric","PvE"};
g.insert_game("EVE Online", "CCP", "CCP", EVE_Online_tags, 20);
...
string Poker_Night_at_the_Inventory_tags[17] = {"Card Game","Casual","Comedy","Singleplayer","Funny","Strategy","Sports","Gambling","Simulation","Conversation","Touch-Friendly","Multiplayer","Indie","First-Person","Point & Click","Memes","Action"};
g.insert_game("Poker Night at the Inventory", "Telltale Games", "", Poker_Night_at_the_Inventory_tags, 17);
...
string MechWarrior_Online_tags[20] = {"Free to Play","Mechs","Action","Multiplayer","Shooter","Robots","Simulation","Sci-fi","FPS","Strategy","Massively Multiplayer","Tactical","PvP","First-Person","War","Walking Simulator","Survival","Team-Based","Open World","Singleplayer"};
...
//Inserting The SKIES
string The_SKIES_tags[20] = {"Early Access","Free to Play","Survival","Open World","Multiplayer","Massively Multiplayer","Post-apocalyptic","Shooter","Zombies","FPS","RPG","Action","Crafting","First-Person","Co-op","PvP","Adventure","Third Person","Third-Person Shooter","Horror"};
...
//Inserting DEFCON
string DEFCON_tags[15] = {"Strategy","Indie","Multiplayer","Wargame","Cold War","Real-Time with Pause","Atmospheric","Simulation","RTS","Diplomacy","2D","Tactical","Singleplayer","War","Great Soundtrack"};
g.insert_game("DEFCON", "Introversion Software", "Introversion Software", DEFCON_tags, 15);
...
string Hunger_Dungeon_tags[16] = {"Free to Play","Multiplayer","Pixel Graphics","Action","Indie","RPG","MOBA","PvP","Fighting","2D","Adventure","Dungeon Crawler","Survival","Co-op","MMORPG","Rogue-like"};
...
string The_Swapper_tags[20] = {"Puzzle","Sci-fi","Atmospheric","Indie","Space","Platformer","Puzzle-Platformer","Adventure","Singleplayer","Great Soundtrack","Psychological Horror","2D","Metroidvania","Action","Exploration","Story Rich","Mystery","Difficult","Side Scroller","Horror"};
...
//Inserting Darwinia
string Darwinia_tags[8] = {"Strategy","Indie","RTS","Singleplayer","Retro","Story Rich","Action","Top-Down"};
g.insert_game("Darwinia", "Introversion Software", "Introversion Software", Darwinia_tags, 8);
...
//Inserting Multiwinia
string Multiwinia_tags[6] = {"Indie","Strategy","RTS","Multiplayer","Singleplayer","Retro"};
g.insert_game("Multiwinia", "Introversion Software", "Introversion Software", Multiwinia_tags, 6);
